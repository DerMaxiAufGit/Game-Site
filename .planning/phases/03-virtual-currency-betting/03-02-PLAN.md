...
must_haves:
  truths:
    ...
    - "Only valid escrow state changes are allowed (e.g. can't forfeit before game starts, can't reverse a released escrow)"
    - "Attempting an invalid escrow state change returns a clear rejection"
  artifacts:
