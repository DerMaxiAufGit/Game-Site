              ...
              <>
                ...
                <div className="space-y-2 border border-zinc-800 rounded-lg p-3">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>{tooltipCopy.allowScratch}</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center gap-2">
                    ...
                    <TooltipContent>{tooltipCopy.strictStraights}</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center gap-2">
                    ...
                    <TooltipContent>{tooltipCopy.fullHouseSum}</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center gap-2">
                    ...
                    <TooltipContent>{tooltipCopy.maxRolls}</TooltipContent>
                  </Tooltip>
                </div>
                ...
                <div className="space-y-2 border border-zinc-800 rounded-lg p-3">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>{tooltipCopy.speedMode}</TooltipContent>
                  </Tooltip>
                </div>
                ...
                <div className="space-y-2 border border-zinc-800 rounded-lg p-3">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>{tooltipCopy.draftMode}</TooltipContent>
                  </Tooltip>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-center gap-2">
                    ...
                    <TooltipContent>{tooltipCopy.duelMode}</TooltipContent>
                  </Tooltip>
                </div>
